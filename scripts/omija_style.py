...
def synthetic_banner() -> str:
    return """
<div class="missionbar"><div class="wrap"><div class="mission">세계 4위 방산 수출국의 깊은 협력사망에서, 공격자가 노리는 말단의 유출 자격증명·인포스틸러 감염 신호를 온톨로지로 원청·프로그램까지 연결해 <b>먼저 확인할 협력사와 방산 프로그램을 짚어내는 조기경보 시스템</b>.</div></div></div>
<div class="synbar">
  <span class="dot"></span>
...
/* mission line — one-sentence value prop, sits above the disclaimer strip */
.missionbar{background:var(--surface);border-bottom:1px solid var(--hair);padding:12px 0}
.missionbar .mission{font-size:13.5px;line-height:1.55;color:var(--ink-2);overflow-wrap:anywhere}
.missionbar .mission b{color:var(--ink);font-weight:600}
@media(max-width:640px){.missionbar{padding:10px 0}.missionbar .mission{font-size:12.5px}}
