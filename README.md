...
**P0-P6 로컬 파이프 + StealthMole live entrypoint + Foundry OSDK read-only demo 완료 · 115 tests green.**
...
전체 회귀까지 같이 확인할 때는 `uv run python scripts/final_demo_check.py --full`을 사용합니다. `out/foundry_demo.html`은 Foundry Python OSDK로 읽은 seed 객체와 링크만 사용합니다.
