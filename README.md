...
## 6. Demo Pages And Screenshots

### Live Pages

| Page | Live URL | Local file | Primary screenshot |
|---|---|---|---|
| 평시 콘솔 | <https://jaemani.github.io/Project-Omija/> | `out/omija_console_home.html` | [`01-console-home`](out/screenshots/playwright/01-console-home--desktop-full.png) |
| 사건 보고서 | <https://jaemani.github.io/Project-Omija/omija_demo.html> | `out/omija_demo.html` | [`06-incident-report`](out/screenshots/playwright/06-incident-report--desktop-full.png) |
| 커버리지 맵 | <https://jaemani.github.io/Project-Omija/data_coverage_map.html> | `out/data_coverage_map.html` | [`02-data-coverage-map`](out/screenshots/playwright/02-data-coverage-map--desktop-full.png) |
| 데이터 증거 | <https://jaemani.github.io/Project-Omija/data_evidence_brief.html> | `out/data_evidence_brief.html` | [`03-data-evidence-brief`](out/screenshots/playwright/03-data-evidence-brief--desktop-full.png) |
| 데이터 계보 | <https://jaemani.github.io/Project-Omija/data_lineage_live.html> | `out/data_lineage_live.html` | [`04-data-lineage-live`](out/screenshots/playwright/04-data-lineage-live--desktop-full.png) |
| Foundry 측정 | <https://jaemani.github.io/Project-Omija/foundry_live_measurement.html> | `out/foundry_live_measurement.html` | [`05-foundry-live-measurement`](out/screenshots/playwright/05-foundry-live-measurement--desktop-full.png) |
| 프로그램 뷰 | <https://jaemani.github.io/Project-Omija/program_threat_view.html> | `out/program_threat_view.html` | [`07-program-threat-view`](out/screenshots/playwright/07-program-threat-view--desktop-full.png) |

### Representative Screenshots

| 평시 콘솔: 4 core concepts | 데이터 계보: provider to Foundry |
|---|---|
| <img src="out/screenshots/playwright/01-console-home--feature-steady-state-top.png" width="420" alt="Steady-state console core concepts"> | <img src="out/screenshots/playwright/04-data-lineage-live--feature-swimlane.png" width="420" alt="Data lineage swimlane"> |

| Foundry SQL measurement | 사건 보고서: active-on-top |
|---|---|
| <img src="out/screenshots/playwright/05-foundry-live-measurement--feature-sql-counts.png" width="420" alt="Foundry SQL counts"> | <img src="out/screenshots/playwright/06-incident-report--feature-triage-and-bands.png" width="420" alt="Incident triage and risk bands"> |

| Blast radius path | Human-reviewed draft |
|---|---|
| <img src="out/screenshots/playwright/06-incident-report--feature-blast-radius-path.png" width="420" alt="Blast radius supply-chain path"> | <img src="out/screenshots/playwright/06-incident-report--feature-human-review-draft.png" width="420" alt="Human-reviewed notification draft"> |

Full screenshot inventory:

- [Playwright screenshot inventory](docs/review/playwright-screenshot-inventory.md)
- [Screenshot manifest](out/screenshots/playwright/manifest.json)
- [Screenshot directory](out/screenshots/playwright/)

## 7. Artifact Versions

| Version | Artifact | Role | Status |
|---|---|---|---|
| V0 | `out/intelligence_demo.html`, `out/omija_console_core.html`, `out/omija_console_graph.html`, `out/omija_console_response.html` | Early no-live-data ontology explanation pages | Historical reference |
| V1 | `out/palantir_v1.html`, `out/palantir_v2.html`, `out/palantir_v3.html` | Early Palantir-style UI variants | Reference only |
| V2 | `out/omija_console_home.html` | Steady-state operating console | Main landing page |
| V3 | `out/omija_demo.html` | Synthetic incident report with active-on-top, of/targets, blast radius, human-reviewed draft | Core demo |
| V4 | `out/data_coverage_map.html` | Map of synthetic seed, public context, engine output, provider rail, Foundry evidence | Demo support |
| V5 | `out/data_evidence_brief.html` | Public OSINT and approved provider boundary explanation | Demo support |
| V6 | `out/data_lineage_live.html` | Approved provider row lineage through redaction, ontology rows, Foundry measurement | Finals data-lineage proof |
| V7 | `out/foundry_live_measurement.html`, `out/foundry_live_measurement/measurement.html` | Sanitized provider rows measured in Foundry schema-aware datasets | Finals measurement proof |
| V8 | `out/program_threat_view.html` | Program-centered reverse query and rollup | Q&A backup |
...
| `out/screenshots/playwright/` | Playwright-captured page and feature screenshots |
